...
export default function Home({ t = {}, division = 'industrial', setDivision = () => {} }) {
  ...
  const safeT = {
    ...
    hero: t?.hero || { title: '', subtitle: '', description: '', industrial: 'Industrial', residential: 'Residential', buildDream: 'Build Your Dream' },
    about: t?.about || { residential: { title: '', description: '', microclaim: '' }, industrial: { title: '', description: '', microclaim: '' }, reach: '', methods: '', team: '', quality: '' },
    process: t?.process || { title: '', description: '', steps: { land: { title: '', desc: '' }, permits: { title: '', desc: '' }, design: { title: '', desc: '' }, supervision: { title: '', desc: '' }, handover: { title: '', desc: '' } } },
    technology: t?.technology || { title: '', challenge_title: '', challenge_desc: '', solution_title: '', solution_desc: '', feature_4dbim_title: '', feature_4dbim_desc: '', feature_quality_title: '', feature_quality_desc: '', feature_future_title: '', feature_future_desc: '', cta: 'Explore Technology' },
    bim_monitoring: t?.bim_monitoring || { title: '', subtitle: '', benefits: [] },
    projects: t?.projects || { title: '', industrial: ['', '', ''], residential: ['', '', ''] }
  };

  // Show loading if critical translations aren't ready
  if (!t || !t.hero || !safeT.hero.title) {
    return (
